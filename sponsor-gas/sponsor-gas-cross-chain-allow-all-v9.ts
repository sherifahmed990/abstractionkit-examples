...
async function main(): Promise<void> {
    ...
    let userOperationsResponse = await smartAccount.createPaymasterUserOperations(
        [
            {
                chainId: chainId1,
                metaTransactions: [
                ...
                paymasterFieldsInitValues: await paymaster.getPaymasterFieldsInitValues(chainId1),
                ...
                paymasterFieldsInitValues: await paymaster.getPaymasterFieldsInitValues(chainId2),
    ...
    userOperations[0].paymasterData =
        await paymaster.getApprovedPaymasterData(userOperations[0])
    userOperations[1].paymasterData =
        await paymaster.getApprovedPaymasterData(userOperations[1])
